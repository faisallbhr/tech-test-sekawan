...
export default function Index({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute z-50 left-0 top-0 flex flex-col h-screen w-72 overflow-y-hidden bg-black duration-300 ease-linear lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-4 py-4 px-4 lg:px-6">
          <div>
            <h3 className="mb-2 ml-4 text-sm font-semibold text-[#8A99AF]">
              MENU
            </h3>
              ...
              {role.includes("admin") && (
                <li>
                  <Link
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#333A48] ${
                      route().current("reservations.*") && "bg-[#333A48]"
                    }`}
                  >
                    <svg
                      className="fill-current"
              ...
              {role.includes("approver") && (
                <li>
                  <Link
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#333A48] ${
                      route().current("approvals.*") && "bg-[#333A48]"
                    }`}
                  >
                    <svg
                      className="fill-current"
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#333A48] ${
                    route().current("profile.*") && "bg-[#333A48]"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  ...
                  method="post"
                  as="button"
                  className={`group w-full relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#333A48]`}
                >
                  <svg
